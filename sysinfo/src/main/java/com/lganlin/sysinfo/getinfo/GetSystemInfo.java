package com.lganlin.sysinfo.getinfo;
...
public class GetSystemInfo {
    ...
    public void printout() {
        ...
        try {
            ...
            System.out.println("cpu个数:" + sigar.getCpuList().length);
            for (int i = 0; i < infos.length; i++) {
                CpuInfo info = infos[i];
                System.out.println("cpu主频:" + info.getMhz() + "MHz");
                System.out.println("cpu厂商：" + info.getVendor());
                System.out.println("cpu型号：" + info.getModel());
                System.out.println("cache数量：" + info.getCacheSize());
